...
new_teams_data = [
    {
        ...
        "phone": "+380671000001",
        "players_count": 11,
        "player_roster": ["Шевченко Олексій", "Бойко Владислав", "Бураков Микола",
                           "Луценко Артем", "Кадар Тамаш", "Сидорчук Сергій",
                           "Гармаш Денис", "Циганков Віктор", "Шапаренко Микола",
                           "Вербич Дєян", "Супряга Артем"],
    },
    {
        "name": "Шахтар",
        ...
        "phone": "+380671000002",
        "players_count": 11,
        "player_roster": ["Трубін Анатолій", "Додо Педро", "Кривцов Сергій",
                           "Маторан Педро", "Степаненко Тарас", "Майкон Мей",
                           "Судаков Георгій", "Марлон Сантос", "Зубков Олег",
                           "Лассіна Траоре", "Антоні Жун"],
    },
    {
        "name": "Металіст",
        ...
        "phone": "+380671000003",
        "players_count": 11,
        "player_roster": ["Кравченко Павло", "Іванов Дмитро", "Семенюк Роман",
                           "Попов Андрій", "Онищенко Богдан", "Голуб Ігор",
                           "Ященко Олег", "Харченко Микита", "Демченко Сергій",
                           "Марченко Юрій", "Литвиненко Артем"],
    },
    {
        "name": "Карпати",
        ...
        "phone": "+380671000004",
        "players_count": 11,
        "player_roster": ["Олексієнко Віктор", "Гавриш Роман", "Рудик Василь",
                           "Козак Олег", "Яремчук Роман", "Борець Микола",
                           "Паращук Андрій", "Захарчин Ігор", "Білик Петро",
                           "Кучер Іван", "Лесюк Михайло"],
    },
    {
        "name": "Ворскла",
        "captain": "Безус Роман",
        ...
        "phone": "+380671000005",
        "players_count": 11,
        "player_roster": ["Безус Роман", "Чеберко Євген", "Процюк Сергій",
                           "Лучкевич Вадим", "Мартиненко Денис", "Тригуба Максим",
                           "Кулач Дмитро", "Чорний Олег", "Сікан Олексій",
                           "Коваль Руслан", "Шайтанов Антон"],
    },
    {
        "name": "Олімпік",
        ...
        "phone": "+380671000006",
        "players_count": 11,
        "player_roster": ["Тищенко Артем", "Бодня Дмитро", "Горленко Олег",
                           "Закалюжний Серхіо", "Гамула Михайло", "Кобець Іван",
                           "Морозенко Ярослав", "Піддубний Сергій", "Руснак Григорій",
                           "Федченко Микола", "Коломієць Андрій"],
    },
    {
        "name": "Чорноморець",
        ...
        "phone": "+380671000007",
        "players_count": 11,
        "player_roster": ["Лещук Владислав", "Дудик Руслан", "Кадєєв Дмитро",
                           "Назаренко Богдан", "Перепелиця Андрій", "Яковенко Олег",
                           "Штурмак Євген", "Цибуленко Максим", "Куліш Іван",
                           "Плюш Сергій", "Горбань Артем"],
    },
]
...
# Дати матчів
match_dates = [
    "2025-06-15", "2025-06-15", "2025-06-15", "2025-06-15",   # тур 1
    "2025-06-17", "2025-06-17", "2025-06-17", "2025-06-17",   # тур 2
    "2025-06-19", "2025-06-19", "2025-06-19", "2025-06-19",   # тур 3
    "2025-06-21", "2025-06-21", "2025-06-21", "2025-06-21",   # тур 4
    "2025-06-23", "2025-06-23", "2025-06-23", "2025-06-23",   # тур 5
    "2025-06-25", "2025-06-25", "2025-06-25", "2025-06-25",   # тур 6
    "2025-06-27", "2025-06-27", "2025-06-27", "2025-06-27",   # тур 7
]
...
stats = {t.name: {"team_obj": t, "played": 0, "won": 0, "drawn": 0,
...
for home, away, hs, as_ in match_results:
    ...
    if hs > as_:
        stats[home]["won"] += 1;  stats[home]["pts"] += 3
        stats[away]["lost"] += 1
    elif hs < as_:
        stats[away]["won"] += 1;  stats[away]["pts"] += 3
        stats[home]["lost"] += 1
    else:
        stats[home]["drawn"] += 1; stats[home]["pts"] += 1
        stats[away]["drawn"] += 1; stats[away]["pts"] += 1
...
print("\n  Турнірна таблиця:")
print(f"  {'#':<3} {'Команда':<14} {'М':<4} {'В':<4} {'Н':<4} {'П':<4} {'ГЗ':<4} {'ГП':<4} {'РГ':<5} {'О'}")
sorted_standings = sorted(stats.values(),
                          key=lambda x: (-x["pts"], -(x["gf"] - x["ga"]), -x["gf"]))
for pos, s in enumerate(sorted_standings, 1):
    gd = s["gf"] - s["ga"]
    print(f"  {pos:<3} {s['team_obj'].name:<14} {s['played']:<4} {s['won']:<4} {s['drawn']:<4} {s['lost']:<4} {s['gf']:<4} {s['ga']:<4} {gd:+d}    {s['pts']}")
